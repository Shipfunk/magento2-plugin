...
class UpgradeSchema  implements UpgradeSchemaInterface
{
    ...
    {
        $setup->startSetup();
        if (version_compare($context->getVersion(), '1.0.4.0') < 0) {
            ...
            $setup->getConnection()->dropTable($setup->getTable('nord_shipfunk_pickups'));
            $setup->getConnection()->dropTable($setup->getTable('nord_shipfunk_selected_pickup'));
        }
        $setup->endSetup();
    }
}